  ...
  <Page {...props}>
    <GalleryContext.Provider value={gallery}>
      ...
      <Gallery.Span className="image main">
        <ImgHeader  alt="Miscellaneous 3D Modeling Gallery" fluid />
      ...
      <span className="span-across align-center">
        <Jump href="https://drive.google.com/open?id=15BXfXkI4uh-wPY9NWNtcDm-uPQQHAJ0x" icon="none" className="image contain">
          <ImgGeoBar alt="Geo-Steering Correlation Animation" fluid />
      ...
      <span className="span-across align-center">
        <Jump href="https://drive.google.com/open?id=15qAXg7Y2k-j4UGEe3tKq12YFyqN-tBiQ" icon="none" className="image contain">
          <ImgOilSandsBar alt="Oil Sands Animation" fluid />
          <div className="label-right">Video</div>
        </Jump>
      </span>
      ...
      <Jump href="https://drive.google.com/open?id=1X8FK2cpaQxLQLB2M7UHaOVgFco98uup9" icon="none" className="image right">
        <ImgBlackholeInset alt="Blackhole Atmosphere Animation" fluid />
        <div className="label-right">Video</div>
      </Jump>
      ...
      <Gallery.Span className="image right" index={0}>
        <ImgLandscapeInset alt="Blackhole Landscape Render" fluid />
      ...
      <Gallery.Span className="image right" index={2}>
        <ImgIceCaveInset alt="Ice Cavern Render" fluid />
        <div className="label-right">Image</div>
      </Gallery.Span>
