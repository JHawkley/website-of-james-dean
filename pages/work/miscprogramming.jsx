...
const MiscProgrammingPage = (props) => (
  <Page {...props} navLeft={ToWork}>
    ...
    <p>The switch from CoffeeScript to TypeScript I actually view as an unfortunate choice.  Many of the patterns I like to use in JavaScript were not compatible with the type-system at the time, mostly object-composition related patterns.  This caused TypeScript to rub me the wrong way as I tried to force it to work the way I wanted through complicated &quot;type-system gymnastics&quot;.</p>
    <p>TypeScript also had very few language features that make programming in it terse and expressive; at the time, it was just a more-restricted sub-set of JavaScript with few added language features over ECMAScript 2015.  I understand it is a design goal of the language to maintain feature parity with JavaScript, but it is regrettable that the language did not do more to support the programmer.  You sometimes just have to accept that you can't make DRY code that is also clear and readable.</p>
