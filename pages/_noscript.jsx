...
const NoJavaScriptPage = ({transitionClass}) => (
  <Page transitionClass={transitionClass} navLeft="none" navRight="none">
    ...
    <h3>Site Summary</h3>
    <p>This is the personal web site for James Dean, a programmer out of the greater Seattle area in Washington, USA.  It showcases my work to potential employers or those otherwise interested in a programmer for a project.</p>
