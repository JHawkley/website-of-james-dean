...
const Intro = (props) => {
  ...
  return (
    <Article {...props}>
      ...
      <p>If you are such a person, please have a look at my <Goto article={$work}>game-specific works here</Goto>, toward the bottom of the page, to help you determine if I might be an asset to your project.</p>
